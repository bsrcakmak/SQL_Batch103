...
Child tabloda ON DELETE CASCADE komutu yazilirsa 
   ...
   2-) Child tablodaki veri silinmeden parent tablodaki veri silinebilir
      PgAdmin ERROR vermez. Parent tablodaki veriyi siler.
...
-- SORU9: malzeme_ismi Laptop olan musteri_isim'ini, (dis sorgu)
--sirket_ismi Apple’in irtibat_isim'i ile güncelleyiniz. (ic sorgu)
