...
--SORU:ogrenciler tablosundaki id vr isim sutununu getiriniz
select id,isim from ogrenciler;

--SORU: Sınav notu 80'den büyük olan öğrencilerin tüm bilgilerini listele
select * from ogrenciler where sinav_notu>80;

-- Adresi Ankara ola ogrencilerin tum bilgilerini listele 
...
--SORU: Sinav notu 65 veya 85 olan ogrencilerin tum bilgilerini listeleyin
...
--SORU: Tablodaki tum satirlari silelim
delete from ogrenciler;

/*
     --CONSTRAINT--
UNIQUE --> Bir sütundaki tüm değerlerin BENZERSİZ/TEKRARSIZ yani tek olmasını sağlar.
NOT NULL --> Bir Sütunun NULL içermemesini yani boş olmamasını sağlar.NOT NULL kısıtlaması için constraint ismi tanımlanmaz. 
