...
insert into child values (101,2000,'Araba','Hasan');
...
drop table parent; --8.soruda child tabloyu sildigimiz icin parent tabloyu simdi silebiliyoruz
...
--komple silinmek isterse cascade ekleyerek parent tablo silinebildi.

--SORU2: parent2 tablosunu siliniz
--on delete cascade sayesinde child tablo silinmeden parent tablo silinebilirdi
